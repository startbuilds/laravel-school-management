...
class VisitorTokenSettingController extends Controller
{
    use FileUploader;
    ...
    {
        // Module Data
        $this->title = trans_choice('module_visitor_token_setting', 1);
        $this->route = 'admin.visitor-token-setting';
        $this->view = 'admin.visitor-token-setting';
        $this->path = 'print-setting';
        $this->access = 'visitor-token-setting';
    ...
    public function index()
    {
        ...
        $data['row'] = PrintSetting::where('slug', 'visitor-token')->first();
